...
/*MODULO VIAJE*/
    ...
    $app->delete('/v2/400/solicitud/opcion/adjunto/{codigo}', function($request) {//20201103
        ...
        if (isset($val00) && isset($val01) && isset($val02) && isset($val03)) {
            ...
            header("Content-Type: application/json; charset=utf-8");
            $json = json_encode(array('code' => 400, 'status' => 'error', 'message' => 'Verifique, algún campo esta vacio.'.$val00.', '.$val01.', '.$val02.', '.$val03), JSON_UNESCAPED_UNICODE | JSON_NUMERIC_CHECK | JSON_PRESERVE_ZERO_FRACTION);
        }
