    ...
    $app->get('/v2/400/solicitud/detalle/{codigo}', function($request) {
        ...
        if (isset($val01)) {
            $sql00  = "SELECT
                ...
                d1.LOCCIUCOD        AS          localidad_ciudad_origen_salida_codigo,
                d1.LOCCIUORD        AS          localidad_ciudad_origen_salida_orden,
                d1.LOCCIUNOM        AS          localidad_ciudad_origen_salida_nombre,
                d1.LOCCIUOBS        AS          localidad_ciudad_origen_salida_observacion,

                e1.LOCPAICOD        AS          localidad_pais_origen_salida_codigo,
                e1.LOCPAIORD        AS          localidad_pais_origen_salida_orden,
                e1.LOCPAINOM        AS          localidad_pais_origen_salida_nombre,
                e1.LOCPAIPAT        AS          localidad_pais_origen_salida_path,
                e1.LOCPAIIC2        AS          localidad_pais_origen_salida_iso_char2,
                e1.LOCPAIIC3        AS          localidad_pais_origen_salida_iso_char3,
                e1.LOCPAIIN3        AS          localidad_pais_origen_salida_iso_num3,
                e1.LOCPAIOBS        AS          localidad_pais_origen_salida_observacion,

                d2.LOCCIUCOD        AS          localidad_ciudad_destino_salida_codigo,
                d2.LOCCIUORD        AS          localidad_ciudad_destino_salida_orden,
                d2.LOCCIUNOM        AS          localidad_ciudad_destino_salida_nombre,
                d2.LOCCIUOBS        AS          localidad_ciudad_destino_salida_observacion,

                e2.LOCPAICOD        AS          localidad_pais_destino_salida_codigo,
                e2.LOCPAIORD        AS          localidad_pais_destino_salida_orden,
                e2.LOCPAINOM        AS          localidad_pais_destino_salida_nombre,
                e2.LOCPAIPAT        AS          localidad_pais_destino_salida_path,
                e2.LOCPAIIC2        AS          localidad_pais_destino_salida_iso_char2,
                e2.LOCPAIIC3        AS          localidad_pais_destino_salida_iso_char3,
                e2.LOCPAIIN3        AS          localidad_pais_destino_salida_iso_num3,
                e2.LOCPAIOBS        AS          localidad_pais_destino_salida_observacion,

                d3.LOCCIUCOD        AS          localidad_ciudad_origen_retorno_codigo,
                d3.LOCCIUORD        AS          localidad_ciudad_origen_retorno_orden,
                d3.LOCCIUNOM        AS          localidad_ciudad_origen_retorno_nombre,
                d3.LOCCIUOBS        AS          localidad_ciudad_origen_retorno_observacion,

                e3.LOCPAICOD        AS          localidad_pais_origen_retorno_codigo,
                e3.LOCPAIORD        AS          localidad_pais_origen_retorno_orden,
                e3.LOCPAINOM        AS          localidad_pais_origen_retorno_nombre,
                e3.LOCPAIPAT        AS          localidad_pais_origen_retorno_path,
                e3.LOCPAIIC2        AS          localidad_pais_origen_retorno_iso_char2,
                e3.LOCPAIIC3        AS          localidad_pais_origen_retorno_iso_char3,
                e3.LOCPAIIN3        AS          localidad_pais_origen_retorno_iso_num3,
                e3.LOCPAIOBS        AS          localidad_pais_origen_retorno_observacion,

                d4.LOCCIUCOD        AS          localidad_ciudad_destino_retorno_codigo,
                d4.LOCCIUORD        AS          localidad_ciudad_destino_retorno_orden,
                d4.LOCCIUNOM        AS          localidad_ciudad_destino_retorno_nombre,
                d4.LOCCIUOBS        AS          localidad_ciudad_destino_retorno_observacion,

                e4.LOCPAICOD        AS          localidad_pais_destino_retorno_codigo,
                e4.LOCPAIORD        AS          localidad_pais_destino_retorno_orden,
                e4.LOCPAINOM        AS          localidad_pais_destino_retorno_nombre,
                e4.LOCPAIPAT        AS          localidad_pais_destino_retorno_path,
                e4.LOCPAIIC2        AS          localidad_pais_destino_retorno_iso_char2,
                e4.LOCPAIIC3        AS          localidad_pais_destino_retorno_iso_char3,
                e4.LOCPAIIN3        AS          localidad_pais_destino_retorno_iso_num3,
                e4.LOCPAIOBS        AS          localidad_pais_destino_retorno_observacion,
            ...
            try {
                ...
                while ($rowMSSQL00 = $stmtMSSQL00->fetch()) {
                    ...
                    $detalle = array(
                        ...
                        'localidad_ciudad_origen_salida_observacion'        => trim(strtolower($rowMSSQL00['localidad_ciudad_origen_salida_observacion'])),

                        'localidad_pais_origen_salida_codigo'               => $rowMSSQL00['localidad_pais_origen_salida_codigo'],
                        'localidad_pais_origen_salida_orden'                => $rowMSSQL00['localidad_pais_origen_salida_orden'],
                        'localidad_pais_origen_salida_nombre'               => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_salida_nombre']))),
                        'localidad_pais_origen_salida_path'                 => trim(strtolower($rowMSSQL00['localidad_pais_origen_salida_path'])),
                        'localidad_pais_origen_salida_iso_char2'            => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_salida_iso_char2']))),
                        'localidad_pais_origen_salida_iso_char3'            => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_salida_iso_char3']))),
                        'localidad_pais_origen_salida_iso_num3'             => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_salida_iso_num3']))),
                        'localidad_pais_origen_salida_observacion'          => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_salida_observacion']))),

                        'localidad_ciudad_destino_salida_codigo'            => $rowMSSQL00['localidad_ciudad_destino_salida_codigo'],
                        'localidad_ciudad_destino_salida_orden'             => $rowMSSQL00['localidad_ciudad_destino_salida_orden'],
                        'localidad_ciudad_destino_salida_nombre'            => trim(strtoupper(strtolower($rowMSSQL00['localidad_ciudad_destino_salida_nombre']))),
                        'localidad_ciudad_destino_salida_observacion'       => trim(strtolower($rowMSSQL00['localidad_ciudad_destino_salida_observacion'])),

                        'localidad_pais_destino_salida_codigo'              => $rowMSSQL00['localidad_pais_destino_salida_codigo'],
                        'localidad_pais_destino_salida_orden'               => $rowMSSQL00['localidad_pais_destino_salida_orden'],
                        'localidad_pais_destino_salida_nombre'              => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_salida_nombre']))),
                        'localidad_pais_destino_salida_path'                => trim(strtolower($rowMSSQL00['localidad_pais_destino_salida_path'])),
                        'localidad_pais_destino_salida_iso_char2'           => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_salida_iso_char2']))),
                        'localidad_pais_destino_salida_iso_char3'           => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_salida_iso_char3']))),
                        'localidad_pais_destino_salida_iso_num3'            => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_salida_iso_num3']))),
                        'localidad_pais_destino_salida_observacion'         => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_salida_observacion']))),

                        'localidad_ciudad_origen_retorno_codigo'            => $rowMSSQL00['localidad_ciudad_origen_retorno_codigo'],
                        'localidad_ciudad_origen_retorno_orden'             => $rowMSSQL00['localidad_ciudad_origen_retorno_orden'],
                        'localidad_ciudad_origen_retorno_nombre'            => trim(strtoupper(strtolower($rowMSSQL00['localidad_ciudad_origen_retorno_nombre']))),
                        'localidad_ciudad_origen_retorno_observacion'       => trim(strtolower($rowMSSQL00['localidad_ciudad_origen_retorno_observacion'])),

                        'localidad_pais_origen_retorno_codigo'              => $rowMSSQL00['localidad_pais_origen_retorno_codigo'],
                        'localidad_pais_origen_retorno_orden'               => $rowMSSQL00['localidad_pais_origen_retorno_orden'],
                        'localidad_pais_origen_retorno_nombre'              => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_retorno_nombre']))),
                        'localidad_pais_origen_retorno_path'                => trim(strtolower($rowMSSQL00['localidad_pais_origen_retorno_path'])),
                        'localidad_pais_origen_retorno_iso_char2'           => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_retorno_iso_char2']))),
                        'localidad_pais_origen_retorno_iso_char3'           => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_retorno_iso_char3']))),
                        'localidad_pais_origen_retorno_iso_num3'            => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_retorno_iso_num3']))),
                        'localidad_pais_origen_retorno_observacion'         => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_origen_retorno_observacion']))),

                        'localidad_ciudad_destino_retorno_codigo'           => $rowMSSQL00['localidad_ciudad_destino_retorno_codigo'],
                        'localidad_ciudad_destino_retorno_orden'            => $rowMSSQL00['localidad_ciudad_destino_retorno_orden'],
                        'localidad_ciudad_destino_retorno_nombre'           => trim(strtoupper(strtolower($rowMSSQL00['localidad_ciudad_destino_retorno_nombre']))),
                        'localidad_ciudad_destino_retorno_observacion'      => trim(strtolower($rowMSSQL00['localidad_ciudad_destino_retorno_observacion'])),

                        'localidad_pais_destino_retorno_codigo'             => $rowMSSQL00['localidad_pais_destino_retorno_codigo'],
                        'localidad_pais_destino_retorno_orden'              => $rowMSSQL00['localidad_pais_destino_retorno_orden'],
                        'localidad_pais_destino_retorno_nombre'             => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_retorno_nombre']))),
                        'localidad_pais_destino_retorno_path'               => trim(strtolower($rowMSSQL00['localidad_pais_destino_retorno_path'])),
                        'localidad_pais_destino_retorno_iso_char2'          => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_retorno_iso_char2']))),
                        'localidad_pais_destino_retorno_iso_char3'          => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_retorno_iso_char3']))),
                        'localidad_pais_destino_retorno_iso_num3'           => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_retorno_iso_num3']))),
                        'localidad_pais_destino_retorno_observacion'        => trim(strtoupper(strtolower($rowMSSQL00['localidad_pais_destino_retorno_observacion']))),
                ...
                if (isset($result)){
                    ...
                    $detalle    = array(
                        ...
                        'localidad_ciudad_origen_salida_nombre'             => '',
                        'localidad_ciudad_origen_salida_observacion'        => '',
    
                        'localidad_pais_origen_salida_codigo'               => '',
                        'localidad_pais_origen_salida_orden'                => '',
                        'localidad_pais_origen_salida_nombre'               => '',
                        'localidad_pais_origen_salida_path'                 => '',
                        'localidad_pais_origen_salida_iso_char2'            => '',
                        'localidad_pais_origen_salida_iso_char3'            => '',
                        'localidad_pais_origen_salida_iso_num3'             => '',
                        'localidad_pais_origen_salida_observacion'          => '',

                        'localidad_ciudad_destino_salida_codigo'            => '',
                        'localidad_ciudad_destino_salida_orden'             => '',
                        'localidad_ciudad_destino_salida_nombre'            => '',
                        'localidad_ciudad_destino_salida_observacion'       => '',
    
                        'localidad_pais_destino_salida_codigo'              => '',
                        'localidad_pais_destino_salida_orden'               => '',
                        'localidad_pais_destino_salida_nombre'              => '',
                        'localidad_pais_destino_salida_path'                => '',
                        'localidad_pais_destino_salida_iso_char2'           => '',
                        'localidad_pais_destino_salida_iso_char3'           => '',
                        'localidad_pais_destino_salida_iso_num3'            => '',
                        'localidad_pais_destino_salida_observacion'         => '',

                        'localidad_ciudad_origen_retorno_codigo'            => '',
                        'localidad_ciudad_origen_retorno_orden'             => '',
                        'localidad_ciudad_origen_retorno_nombre'            => '',
                        'localidad_ciudad_origen_retorno_observacion'       => '',
    
                        'localidad_pais_origen_retorno_codigo'              => '',
                        'localidad_pais_origen_retorno_orden'               => '',
                        'localidad_pais_origen_retorno_nombre'              => '',
                        'localidad_pais_origen_retorno_path'                => '',
                        'localidad_pais_origen_retorno_iso_char2'           => '',
                        'localidad_pais_origen_retorno_iso_char3'           => '',
                        'localidad_pais_origen_retorno_iso_num3'            => '',
                        'localidad_pais_origen_retorno_observacion'         => '',

                        'localidad_ciudad_destino_retorno_codigo'           => '',
                        'localidad_ciudad_destino_retorno_orden'            => '',
                        'localidad_ciudad_destino_retorno_nombre'           => '',
                        'localidad_ciudad_destino_retorno_observacion'      => '',
    
                        'localidad_pais_destino_retorno_codigo'             => '',
                        'localidad_pais_destino_retorno_orden'              => '',
                        'localidad_pais_destino_retorno_nombre'             => '',
                        'localidad_pais_destino_retorno_path'               => '',
                        'localidad_pais_destino_retorno_iso_char2'          => '',
                        'localidad_pais_destino_retorno_iso_char3'          => '',
                        'localidad_pais_destino_retorno_iso_num3'           => '',
                        'localidad_pais_destino_retorno_observacion'        => '',
