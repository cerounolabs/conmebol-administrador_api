    ...
    $app->get('/v2/400/solicitud/opcionvuelo/{codigo}', function($request) {
        ...
        if(isset($val01)) {
            $sql00  = "SELECT 
                ...
                a.SOLOPVSAL	    AS      solicitud_opcionvuelo_salida,
                a.SOLOPVLLE	    AS      solicitud_opcionvuelo_llegada,    
                ...
                c.SOLOPCTIM     AS      solicitud_opcioncabecera_tarifa_importe,
                c.SOLOPCTVS     AS      solicitud_opcioncabecera_visualiza_solicitante,
                c.SOLOPCTVJ     AS      solicitud_opcioncabecera_visualiza_jefatura,
                c.SOLOPCTVE     AS      solicitud_opcioncabecera_visualiza_ejecutivo,
                c.SOLOPCTVP     AS      solicitud_opcioncabecera_visualiza_proveedor,
                c.SOLOPCRES     AS      solicitud_opcioncabecera_reserva,
                c.SOLOPCCO1     AS      solicitud_opcioncabecera_comentario_1,
            ...
            try {
                ...
                while ($rowMSSQL00 = $stmtMSSQL00->fetch()) {
                    ...
                    $detalle    = array(
                        ...
                        'solicitud_opcionvuelo_salida'                      => trim(strtoupper(strtolower($rowMSSQL00['solicitud_opcionvuelo_salida']))),
                        'solicitud_opcionvuelo_llegada'                     => trim(strtoupper(strtolower($rowMSSQL00['solicitud_opcionvuelo_llegada']))),
