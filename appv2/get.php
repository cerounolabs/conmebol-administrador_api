    ...
    $app->get('/v2/400/solicitud/documento/{codigo}', function($request) {
        ...
        if (isset($val01)) {
            $sql00  = "SELECT
                ...
                WHERE (a.SOLFICDNS = ? OR a.SOLFICDNJ = ? OR a.SOLFICDNE = ? OR a.SOLFICDNP = ?) AND j.WRKDETCOD = (SELECT MIN(j1.WRKDETCOD) FROM [wrk].[WRKDET] j1 WHERE j1.WRKDETWFC = a.SOLFICWFC AND j1.WRKDETEAC = a.SOLFICECC)
