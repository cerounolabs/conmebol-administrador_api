...
/*MODULO RENDICION*/
    ...
    $app->get('/v2/500/rendicion/solicitante/documento/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/500/rendicion/jefatura/documento/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/500/rendicion/analista/documento/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
