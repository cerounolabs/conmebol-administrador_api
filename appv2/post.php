...
/*MODULO PERMISOS*/
    $app->post('/v2/200/tarjeta/personal/redes/sociales', function($request) {
        require __DIR__.'/../src/connect.php';
        ...
        if (isset($val01) && isset($val03) &&  isset($val04)) {        
            $sql00  = "INSERT INTO [hum].[TPERSO] (TPERSOEST, TPERSOORD, TPERSOTRC, TPERSOTAC, TPERSODIR, TPERSOOBS, TPERSOAUS, TPERSOAFH, TPERSOAIP) VALUES ((SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'SISTEMAESTADO' AND DOMFICPAR = ?), ?, (SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'REDSOCIALTIPO' AND DOMFICPAR = ?), ?, ?, ?, ?, GETDATE(), ?)";
    ...
    $app->post('/v2/200/tarjeta/personal/telefono/prefijos', function($request) {
        require __DIR__.'/../src/connect.php';
        ...
        if (isset($val01) && isset($val03) &&  isset($val04)) {        
            $sql00  = "INSERT INTO [hum].[TPETEL] (TPETELEST, TPETELORD, TPETELTPC, TPETELTAC, TPETELVIS, TPETELNUM, TPETELOBS, TPETELAUS, TPETELAFH, TPETELAIP) VALUES ((SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'SISTEMAESTADO' AND DOMFICPAR = ?), ?, (SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'REDSOCIALTIPO' AND DOMFICPAR = ?), ?, ?, ?, ?, GETDATE(), ?)";
...
/*MODULO VIAJE*/
    ...
    $app->post('/v2/400/solicitud/opcion/cabecera', function($request) {//20201123
        ...
        if (isset($val01) && isset($val02) && isset($val03) && isset($val13)) {
