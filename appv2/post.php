...
/*MODULO VIAJE*/
    ...
    $app->post('/v2/400/solicitud', function($request) {
        ...
        if (isset($val01) && isset($val02) && isset($val03) && isset($val04) && isset($val05) && isset($val06) && isset($val07) && isset($val08)) {
            ...
            try {
                ...
                $stmtMSSQL00= $connMSSQL->prepare($sql00);
                $stmtMSSQL00->execute([$val01, $val02, $val03, $val04, $val05, $val06, $val07, $val08, $val09, $val10, $val11, $val12, $val13, $val14, $val15, $val16, $val17, $val18, $val19, $val20, $val21, $aud01, $aud03]);
    ...
    $app->post('/v2/400/solicitud/detalle', function($request) {
        ...
        if (isset($val01) && isset($val02) && isset($val03) && isset($val05)) {
            $sql00  = "INSERT INTO [via].[SOLDET] (SOLDETEST, SOLDETCOC, SOLDETCDC, SOLDETAEC, SOLDETSOC, SOLDETPRE, SOLDETFLL, SOLDETFRE, SOLDETHLL, SOLDETHRE, SOLDETCON, SOLDETSAL, SOLDETVEH, SOLDETSCC, SOLDETOBS, SOLDETAUS, SOLDETAFH, SOLDETAIP) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, GETDATE(), ?)";
