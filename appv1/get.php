        ...
        try {
            ...
            while ($rowMSSQL00 = $stmtMSSQL00->fetch()) {
                ...
                $detalle    = array(
                    ...
                    'testpcr_adjunto_1'                         => trim(strtolower($rowMSSQL00['testpcr_adjunto_1'])),
                    'testpcr_adjunto_2'                         => trim(strtolower($rowMSSQL00['testpcr_adjunto_2'])),
                    'testpcr_adjunto_3'                         => trim(strtolower($rowMSSQL00['testpcr_adjunto_3'])),
                    'testpcr_adjunto_4'                         => trim(strtolower($rowMSSQL00['testpcr_adjunto_4'])),
