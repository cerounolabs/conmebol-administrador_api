<?php
    ...
    $app->get('/v1/000/marcacion', function($request) {
        ...
        try {
            ...
            while ($rowMSSQL = $stmtMSSQL->fetch()) {
                $marcacion_entrada_oficina_hora = (strlen(trim($rowMSSQL['marcacion_entrada_oficina_hora'])) > 999 ? (String)($rowMSSQL['marcacion_entrada_oficina_hora']).'00' : '0'.trim($rowMSSQL['marcacion_entrada_oficina_hora']).'00');
                $marcacion_salida_almuerzo_hora = (strlen(trim($rowMSSQL['marcacion_salida_almuerzo_hora'])) > 999 ? (String)($rowMSSQL['marcacion_salida_almuerzo_hora']).'00' : '0'.trim($rowMSSQL['marcacion_salida_almuerzo_hora']).'00');
                $marcacion_entrada_almuerzo_hora= (strlen(trim($rowMSSQL['marcacion_entrada_almuerzo_hora'])) > 999 ? (String)($rowMSSQL['marcacion_entrada_almuerzo_hora']).'00' : '0'.trim($rowMSSQL['marcacion_entrada_almuerzo_hora']).'00');
                $marcacion_salida_oficina_hora  = (strlen(trim($rowMSSQL['marcacion_salida_oficina_hora'])) > 999 ? (String)($rowMSSQL['marcacion_salida_oficina_hora']).'00' : '0'.trim($rowMSSQL['marcacion_salida_oficina_hora']).'00');
